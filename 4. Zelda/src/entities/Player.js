...
import PlayerCarryingIdlingState from "../states/entity/player/PlayerCarryingIdlingState.js";
...
export default class Player extends GameEntity {
	...
	static THROWING_SPRITE_WIDTH = 16;
	static THROWING_SPRITE_HEIGHT = 32;
	...
	constructor() {
		...
		this.throwingSprites = Sprite.generateSpritesFromSpriteSheet(
			images.get(ImageName.PlayerLift),
			Player.THROWING_SPRITE_WIDTH,
			Player.THROWING_SPRITE_HEIGHT
		);
		...
		this.liftHitbox = new Hitbox(0, 0, 0, 0, 'lime');
	...
	initializeStateMachine() {
		...
		stateMachine.add(PlayerStateName.CarryingIdle, new PlayerCarryingIdlingState(this));
	...
	heal(health){
		this.health = this.health + health > this.totalHealth ? this.totalHealth : this.health + health;
	}
