...
- 💯**Worth**: 7%
- 📅**Due**: October 10, 2022 @ 23:59
- 🙅🏽‍**Penalty**: Late submissions lose 10% per day to a maximum of 3 days. Nothing is accepted after 3 days and a grade of 0% will be given.

## 🎯 Objectives

- Read and understand all of the Mario [notes](https://jac-cs-game-programming-fall22.github.io/Notes/#/3-Mario/) and [source code](https://github.com/JAC-CS-Game-Programming-Fall22/3-Mario) from Lecture 3.
